...
public class SearchPunishment extends JFrame{
	private static final long serialVersionUID = 5870864087464173884L;
	
	private DAOPunishment_IMP daoPunishment = new DAOPunishment_IMP();
	...
	private String[] column = { "记录号", "学号", "级别代码", "记录时间", "是否生效 ", "描述"};
	...
	public void init() {
		...
		this.add(btn2);
		String[][] res = daoPunishment.searchPunishment("", 1);
        ...
        btn1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String[][] res = daoPunishment.searchPunishment(jtfstr, 0);
				myTableModel = new DefaultTableModel(res, column);
