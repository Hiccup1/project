...
public class SearchChange extends JFrame{
	private static final long serialVersionUID = 5870864087464173884L;
	
	private DAOChange_IMP daoChange = new DAOChange_IMP();
	...
	private String[] column = { "记录号", "学号", "变更代码", "记录时间", "描述"};
	...
	public void init() {
		...
		this.add(btn2);
		String[][] res = daoChange.searchChange("", 1);
        ...
        btn1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String[][] res = daoChange.searchChange(jtfstr, 0);
				myTableModel = new DefaultTableModel(res, column);
